...
public class FightService : IFightService
{
    ...
    public FightService(DataContext context, IUserService userService, IMapper mapper)
    {
        _context = context;
    ...
    public async Task<ServiceResponse<AttackResultDto>> WeaponAttack(WeaponAttackDto request)
    {
        ...
        try
        {
            var attacker = await _context.Characters
                .Include(c => c.Weapon)
                .Include(c => c.User)
                .FirstOrDefaultAsync(c => c.Id == request.AttackerId && c.User!.Id == _userService.GetUserId());
